...
O repositório [clojure-labs](https://github.com/caramelotech/clojure-labs) também contém um projeto Leiningen com namespaces práticos para explorar no REPL, além de exercícios e projetos na pasta `examples/`.
